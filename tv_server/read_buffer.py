...
from tv_server.backend.protocol import get_message_cls_by_index
...
class ReadBuffer(object):
    ...
    def read_message(self):
        ...
        (marker_foot,) = unpack('>I', data[-4:])

        # Make sure that we're perfectly in alignment with the message 
        # boundaries. 
        if marker_head != marker_foot:
            return None

        cls = get_message_cls_by_index(msg_type)
        message = cls()
